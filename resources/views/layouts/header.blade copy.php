      ...
      <div class="container position-sticky z-index-sticky top-0"><div class="row"><div class="col-12">
        <nav class="navbar navbar-expand-lg  blur border-radius-xl top-0 z-index-fixed shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          ...
          <a href="{{route('Etablissements.index')}}" class="dropdown-item border-radius-md">
            <span>Etablissements sanitaires</span>
          </a>
        </div>
                  </div>
                </li>
          ...
          <a href="{{route('Rapports.index')}}" class="dropdown-item border-radius-md">
          ...
          <a href="{{route('Rapports.index')}}" class="dropdown-item border-radius-md">
            <span>Soumis</span>
                ...
                <li class="nav-item my-auto ms-3 ms-lg-0">
                  ...
                  <a href="#" class="btn btn-sm  bg-gradient-secondary  mb-0 me-1 mt-2 mt-md-0">{{ Auth::user()->name }}</a>
